<?php
	...
	try {
		...
		$mensagemEmail = 'Nome: ' . $nome . '<br>' . 'E-mail: ' . $email . '<br>'  . 'Telefone: ' . $telefone . '<br>' . 'Mensagem: ' . $mensagem;
		$mensagemRetorno = 'Olá, ' . $nome . '! Seu e-mail foi recebido com sucesso, entrarei em contato assim que possível! Por favor confira os dados abaixo: <br>' . 'Nome: '. $nome . '<br>' . 'E-mail: ' . $email. '<br>' . 'Telefone: ' . $telefone . '<br>' . 'Mensagem: ' . $mensagem . '<br>';
